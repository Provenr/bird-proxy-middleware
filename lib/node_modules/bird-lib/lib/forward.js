...
var upload2Platform = require('../../../legacy/lib/upload2Platform');
    ...
    var forwardRequest = httpOrHttps.request(urlOptions, function (forwardResponse) {
        ...
        forwardResponse.on('end', function () {
            ...
            try {
                ...
                upload2Platform(config, req, res, function () {
                }, function () {
                }, rawBody, reqChunk, forwardUrl);
            } catch (e) {
...
module.exports = function (config, hitRouteInfo, server, req, res, next) {
    ...
    // <<[ 解析所用的 retryMethod ]{c2i4y_xpby9k6d_ionj07vm}>>
